...
export var NOT_SCHEDULER_ERROR = 'proc first argument must be a scheduler';
export var NOT_ITERATOR_ERROR = 'proc second argument (Saga function result) must be an iterator';
...
export default function proc(scheduler, iterator) {
  var subscribe = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : function () {
    return noop;
  };
  var dispatch = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : noop;
  var getState = arguments.length > 4 && arguments[4] !== undefined ? arguments[4] : noop;
  var options = arguments.length > 5 && arguments[5] !== undefined ? arguments[5] : {};
  var parentEffectId = arguments.length > 6 && arguments[6] !== undefined ? arguments[6] : 0;
  var name = arguments.length > 7 && arguments[7] !== undefined ? arguments[7] : 'anonymous';
  var cont = arguments[8];

  check(scheduler, (typeof scheduler === 'undefined' ? 'undefined' : _typeof(scheduler)) == Scheduler, NOT_SCHEDULER_ERROR);
  ...
  **/
  ...
  function runForkEffect(_ref6, effectId, cb) {
    ...
    try {
      scheduler.suspend();
      var _task = proc(scheduler, taskIterator, subscribe, dispatch, getState, options, effectId, fn.name, detached ? null : noop);
